                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput" name="brand" >
                        </fieldset>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput" name="realm" >
                        </fieldset>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput" name="size">
                        </fieldset>
                    </div>
                </div>
                <fieldset class="form-group">
                    <label for="basicTextarea">محصولات تولیدی:</label>
                    <textarea class="form-control" id="basicTextarea" rows="3" name="products"></textarea>
                </fieldset>
                <hr>
                <fieldset class="form-group">
