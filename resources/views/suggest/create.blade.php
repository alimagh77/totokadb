...
@section('content')
    <form action="/suggest" class="form" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body text-right">
            <div class="card-block">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-1 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                            <label for="basicInput">: قیمت تک</label>
                            <input type="text" class="form-control text-right" id="basicInput" name="single">
                        </fieldset>
                    </div>
                    <div class="col-xl-1 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                            <label for="basicInput">: قیمت ست</label>
                            <input type="text" class="form-control text-right" id="basicInput" name="set">
                        </fieldset>
                    </div>
                    <div class="col-xl-1 col-lg-6 col-md-12 mb-1">
                        <fieldset class="form-group">
                            <label for="basicInput">: قیمت کارتن</label>
                            <input type="text" class="form-control text-right" id="basicInput" name="box">
                        </fieldset>
                    </div>
                </div>
                <fieldset class="form-group">
